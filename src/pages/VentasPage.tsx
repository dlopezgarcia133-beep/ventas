...
const FormularioVentaMultiple = () => {
  ...
  const totalComisionHoy = comisionAccHoy + comisionTelHoy + comisionChipsHoy;
                ...
                <tbody>
                  {ventasHoyAcc.map((v) => (
                    <tr key={`acc-${v.id}`}>
                      ...
                      <td style={tdStyle}>
                        <span style={{ color: v.cancelada ? '#ef4444' : '#22c55e', fontWeight: 600, fontSize: 13 }}>
                  ...
                  {chipsHoy.map((c, i) => (
                    <tr key={`chip-${i}`}>
                      ...
                      <td style={tdStyle}>—</td>
                      <td style={tdStyle}><span style={{ color: '#22c55e', fontWeight: 600, fontSize: 13 }}>Activa</span></td>
                      <td style={tdStyle}></td>
                    </tr>
                  ))}
          ...
          <Paper sx={{ p: 2.5, bgcolor: '#f97316', color: 'white', border: 'none' }}>
            ...
            <Box display="flex" flexDirection="column" gap={1}>
              ...
              <Box display="flex" justifyContent="space-between">
                ...
                <Typography variant="body2" fontWeight={600}>${comisionChipsHoy.toFixed(2)}</Typography>
              </Box>
            </Box>
